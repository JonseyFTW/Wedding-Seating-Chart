...
const SortableGuestItem: React.FC<SortableGuestItemProps> = React.memo(
...
export const GuestEditor: React.FC<GuestEditorProps> = React.memo(
  ({ table, tableNumber, onClose }) => {
    ...
    return (
      <div
        className="fixed inset-0 flex items-start justify-center bg-black bg-opacity-50 pt-16 md:pt-24 p-4 z-50"
      ...
      >
        ...
        >
          <div className="relative text-center mb-4 p-6 border-b border-[#F4E1B2]">
