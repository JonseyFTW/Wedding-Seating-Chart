...
import { Plus, Minus, ArrowLeft, Save, Heart, Sparkles, LogOut, Mail, Download, Grid } from 'lucide-react';
  ...
  <div className="max-w-7xl mx-auto px-6">
    <div className="flex items-center justify-between py-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 px-4 py-2 text-[#4A3B52] bg-white hover:bg-gray-50 rounded-full transition-all duration-300 text-sm border border-[#D3A6B8]/20 shadow-sm hover:shadow-md">
